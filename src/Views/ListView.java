...
public class ListView {
	...
	public ListView(ListController controller, String modelTitle) {
		...
		deleteButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (row == -1) {
					JOptionPane.showMessageDialog(null,
							"Nenhum registro selecionado.", "Erro",
							JOptionPane.ERROR_MESSAGE);
				} else
		...
		updateButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (row == -1) {
					...
					new FormView(controller, table.getValueAt(row, 0));
				}
			}
		});
		...
		tableScrollPane.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(),
				"Lista de " + modelTitle, TitledBorder.CENTER, TitledBorder.TOP));
